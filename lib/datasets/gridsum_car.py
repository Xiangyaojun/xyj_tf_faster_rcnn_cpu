...
class gridsum_car(imdb):
  ...
  def _get_default_path(self):
    ...
    """
    return os.path.join(cfg.DATA_DIR, 'gridsum_car')
  ...
  def _load_pascal_annotation(self, index):
    ...
    objs = [obj for obj in objs if obj.find('name').text.lower().strip() in self._class_to_ind.keys()]
  ...
  def _write_voc_results_file(self, all_boxes):
    for cls_ind, cls in enumerate(self.classes):
      if cls == '__background__':
        continue
      print('Writing {} gridsum results file'.format(cls))
